/* sections/contacto.js — Footer y Contacto
   EDITAR: teléfonos, dirección, redes sociales, copyright */
(function () {
...
.ft-brand .ft-name { font-family: var(--f-head); font-size: 1.8rem; letter-spacing: .1em; color: var(--white); margin-top: .75rem; }
.ft-brand .ft-sub { font-size: .57rem; font-weight: 500; letter-spacing: .38em; text-transform: uppercase; color: var(--red); }
.ft-brand p { font-size: .87rem; line-height: 1.75; color: rgba(255,255,255,.5); margin: 1rem 0 1.5rem; max-width: 260px; }
.ft-socials { display: flex; gap: .6rem; }
.ft-soc { width: 38px; height: 38px; background: rgba(255,255,255,.06); border: 1px solid rgba(255,255,255,.1); display: flex; align-items: center; justify-content: center; transition: all .2s; font-size: .8rem; font-weight: 700; color: var(--white); }
...
.ft-bottom { padding: 1.25rem 0; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: .5rem; }
  ...
  <div class="container">
    <div class="ft-grid">
      ...
      <div class="ft-brand reveal">
        <!-- Logo -->
        <img src="assets/img/logo.png" alt="Neira York Coffee"/>
        <div class="ft-name">NEIRA YORK</div>
        <div class="ft-sub">c o f f e e</div>
        <p>Café especial colombiano desde el corazón de Caldas. Comprometidos con los caficultores y la excelencia en cada taza.</p>
        <!-- ── REDES SOCIALES — actualiza los href ── -->
      ...
      <!-- ── COLUMNA CONTACTO — actualiza teléfonos y dirección ── -->
      <div class="reveal d2">
      ...
      <div class="reveal d3">
        ...
        <ul class="ft-nav">
          ...
          <li><a href="#servicios">Maquila y Empaque</a></li>
